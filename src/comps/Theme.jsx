...
const Theme = () => {
  ...
  const selectBtnClick = (e) => {
    ...
    const colorSetData = e.currentTarget.dataset.colors
      .split(",")
    ...
    // tagsList = {listName: ["listName1", "listName2", ...], listTags: ["listName1's tags here", "listName2's tags here"] }
  ...
  return (
    <div>
      <div>
        <p className="mb-2">
          Obviously pink is not for everyone, so choose the colour theme for
          your extension~!
        </p>
        <p>
          ➼ This will create the <span className="font-bold">styles.css</span>{" "}
      ...
      <div className="grid grid-cols-3 gap-2 w-full place-items-center mb-2">
        <div className="myColorSelect" id="PinkSet">
          ...
          <Btn
            ...
            dataColorSet="#fff4f7, #ffdce5, #dd7b94"
          />
        </div>
        <div className="myColorSelect" id="PurpleSet">
          ...
          <Btn
            ...
            style="text-xs"
            onclick={selectBtnClick}
            dataColorSet="#fff4fe, #ffdcfd, #dd7bd3"
          />
        </div>
        <div className="myColorSelect" id="BlueSet">
          ...
          <Btn
            ...
            style="text-xs"
            onclick={selectBtnClick}
            dataColorSet="#f4f4ff, #dce3ff, #7b8fdd"
          />
        </div>
        <div className="myColorSelect" id="GreenSet">
          ...
          <Btn
            ...
            style="text-xs"
            onclick={selectBtnClick}
            dataColorSet="#fefae0, #ccd5ae, #588157"
          />
        </div>
        <div className="myColorSelect" id="OrangeSet">
          ...
          <Btn
            ...
            style="text-xs"
            onclick={selectBtnClick}
            dataColorSet="#ffe9df, #f7b799, #e0826d"
          />
        </div>
        <div className="myColorSelect" id="BrownSet">
          ...
          <Btn
            ...
            style="text-xs"
            onclick={selectBtnClick}
            dataColorSet="#f9f3eb, #e3d5ca, #786153"
          />
        </div>
      </div>
    </div>
