...
const Header = () => {
  return (
    <div className="flex justify-between p-2 bg-[#ffdce5] md:rounded-t-md border-b border-[#b5b5b5]">
      <div className="flex gap-1 items-center">
        <img src="../../src/assets/love.gif" alt="" className="h-fit" />
        <h1 className="font-medium text-[#dd7b94]">
          Taggerator - tags extension creator
        </h1>
      </div>
